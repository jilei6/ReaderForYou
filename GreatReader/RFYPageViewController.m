...
@interface RFYPageViewController () <UIScrollViewDelegate,
                                     UIGestureRecognizerDelegate,
                                     PDFPageContentViewDelegate>
@property (nonatomic, strong, readwrite) RFYPage *page;
@property (nonatomic, strong, readwrite) RFYPageContentView *contentView;
@property (nonatomic, strong) UIImageView *lowResolutionView;
@property (nonatomic, strong) UIPopoverController *popover;
@end

@implementation RFYPageViewController
...
- (instancetype)initWithPage:(RFYPage *)page
{
    ...
    if (self) {
        ...
        dispatch_async(queue, ^{
            RFYPageScanner *scanner = [[RFYPageScanner alloc] initWithCGPDFPage:page.CGPDFPage];
...
- (void)viewDidLoad
{
    ...
    self.contentView = [[RFYPageContentView alloc] initWithFrame:self.frameThatFits];
...
- (void)singleTapped:(UITapGestureRecognizer *)recognizer
{
    ...
    RFYPageLink *link = [self.page linkAtPoint:CGPointMake(point.x / scale,
                                                           point.y / scale)];
    if (link) {
...
- (UIMenuController *)selectionMenuForContentView:(RFYPageContentView *)contentView
{
