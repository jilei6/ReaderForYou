...
{
    RFYDocument *doc = [self.selectedDocuments firstObject];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue.identifier isEqual:DocumentListViewControllerSeguePDFDocument]) {
        ...
        RFYDocumentViewController *vc =
                (RFYDocumentViewController *)navi.topViewController;
        vc.hidesBottomBarWhenPushed = YES;
        RFYDocument *document = [self.selectedDocuments firstObject];
...
- (id<DocumentCell>)documentCellForDocument:(RFYDocument *)document { return nil; }
