...
- (RFYDocumentViewController *)documentViewControllerFromContainer:(UIViewController *)container
{
    UINavigationController *navi = (UINavigationController *)container;
    return (RFYDocumentViewController *)[navi topViewController];
}
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    RFYDocumentViewController *documentViewController =
