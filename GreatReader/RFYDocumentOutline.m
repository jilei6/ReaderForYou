...
@interface RFYDocumentOutline ()
@property (nonatomic, strong, readwrite) NSArray *items;
@end

@implementation RFYDocumentOutline
                    ...
                    document:(CGPDFDocumentRef)document
{
    ...
    return [children grt_map:^(NSValue *value) {
        ...
        NSUInteger pageNumber = [self pageNumberOfDictionary:dic
                                                    document:document
                                                 destination:&dest];
        RFYDocumentOutlineItem *item = [[RFYDocumentOutlineItem alloc]
                                           initWithTitle:title
...
{
    RFYDocumentOutlineItem *current = nil;
    for (RFYDocumentOutlineItem *item in self.items) {
...
{
    return [[self.items grt_map:^(RFYDocumentOutlineItem *item) {
