//
//  RFYDocumentSearchViewController.m
//  GreatReader
//
...
#import "RFYDocumentSearchStateCell.h"
...
@interface RFYDocumentSearchViewController () <UISearchBarDelegate>
@property (nonatomic, strong) UISearchBar *searchBar;
@property (nonatomic, strong) RFYDocumentSearchStateCell *stateCell;
@property (nonatomic, strong) FBKVOController *kvoController;
@end

@implementation RFYDocumentSearchViewController
...
- (void)viewDidLoad
{
    ...
    RFYDocumentSearchStateCell *cell = [[RFYDocumentSearchStateCell alloc] init];
    self.stateCell = cell;
    [self.kvoController observe:self.viewModel
                        keyPath:@"searching"
                        options:0
                          block:^(id vc, RFYDocumentSearchViewModel *vm, NSDictionary *change) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    RFYDocumentSearchResult *result = [self.viewModel resultAtIndexPath:indexPath];
