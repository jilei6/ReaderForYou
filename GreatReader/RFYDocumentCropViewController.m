//
//  RFYDocumentCropViewController.m
//  GreatReader
//
...
@interface RFYDocumentCropViewController () <UIGestureRecognizerDelegate>
@property (nonatomic, strong) RFYPageCropViewController *pdfPageViewController;
@property (nonatomic, assign) BOOL fullScreen;
@property (nonatomic, strong) UIButton *modeButton;
@property (nonatomic, strong) IBOutlet PDFDocumentCropLayoutView *layoutView;
@end

@implementation RFYDocumentCropViewController
...
- (void)viewDidLoad
{
    ...
    RFYPage *page = [self.document pageAtIndex:self.document.currentPage];
    self.pdfPageViewController =
            [[RFYPageCropViewController alloc] initWithPage:page];
