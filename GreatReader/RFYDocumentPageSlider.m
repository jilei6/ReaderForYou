...
@interface RFYDocumentPageSlider ()
...
@implementation RFYDocumentPageSlider
...
- (void)setModel:(RFYDocumentPageSliderModel *)model
{
    _model = model;
    ...
    [self.kvoController observe:self.model
                        ...
                        options:NSKeyValueObservingOptionInitial
                          block:^(RFYDocumentPageSlider *slider, id obj, NSDictionary *change) {
    ...
    [self.kvoController observe:self.model
                        keyPath:@"canGoBack"
                        options:NSKeyValueObservingOptionInitial
                          block:^(RFYDocumentPageSlider *slider, RFYDocumentPageSliderModel *model, NSDictionary *change) {
