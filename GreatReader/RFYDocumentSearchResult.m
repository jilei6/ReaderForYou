...
@interface RFYDocumentSearchResult ()
...
@implementation RFYDocumentSearchResult

+ (RFYDocumentSearchResult *)resultWithSurroundingText:(NSString *)surroundingText
                                                 range:(NSRange)range
                                                atPage:(NSUInteger)page;
{
    RFYDocumentSearchResult *result = [RFYDocumentSearchResult new];
    result.range = range;
    result.page = page;
...
@implementation RFYDocumentSearchResult (TableViewCellAdditions)
